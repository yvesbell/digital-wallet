...
lines = np.genfromtxt("/Users/yvesbell/Documents/digital-wallet/insight_testsuite/temp/paymo_input/batch_payment.txt", delimiter=",", dtype=None)
my_dict_hist = dict()

# Read csv file of future transactions and create dictionnary    
lines2 = np.genfromtxt("/Users/yvesbell/Documents/digital-wallet/insight_testsuite/temp/paymo_input/stream_payment.txt", delimiter=",", dtype=None, comments='@@@')
my_dict_trans = dict()
...
fw = open('/Users/yvesbell/Documents/digital-wallet/insight_testsuite/temp/paymo_output/output1.txt', 'w')
for key in my_dict_trans:
    fw.write(feature1(key, my_dict_trans[key]) + '\n')
fw.close()

# Loop thru transaction dict and output to file 2 (feature 2)
fw2 = open('/Users/yvesbell/Documents/digital-wallet/insight_testsuite/temp/paymo_output/output2.txt', 'w')
for key in my_dict_trans:
    fw2.write(feature2(key, my_dict_trans[key]) + '\n')
fw2.close()

# Loop thru transaction dict and output to file 3 (feature 3)
fw3 = open('/Users/yvesbell/Documents/digital-wallet/insight_testsuite/temp/paymo_output/output3.txt', 'w')
for key in my_dict_trans:
